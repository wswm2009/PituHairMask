...
+ (NSString *)saveImage:(UIImage *)tempImage WithPath:(NSString *)filePath WithName:(NSString *)imageName{
    ...
    NSMutableString *tempPath=[NSMutableString stringWithString:documentsDirectory];
    [tempPath appendFormat:@"/%@",filePath];
    NSString* fullPathToFile = [tempPath stringByAppendingPathComponent:imageName];
    
  //  NSArray *nameAry=[fullPathToFile componentsSeparatedByString:@"/"];
  //  [YYHelper YYLog:fullPathToFile,nil];
